...
$campInfoURLPrefix = "http://otmtrk.info/code/";
$campPixUrlPrefix = "http://otmtrk.info/code/pix/";
...
if ($campaign_id) {
    ...
    if (debug_mode_enabled()) {
        ...
        $lpName = isset($_GET['lp']) ? $_GET['lp'] : NULL;
        ...
        // $campInfoUrl = $campInfoURLPrefix.$trkCampName.".txt";

        /* 

        Retreives external file to setup these variables required in the following code include
        ...
        */
/*
        $filedata = @file_get_contents($campInfoUrl);
        if(!$filedata){
            // Failed to get campaign data variables. Show safe page.
